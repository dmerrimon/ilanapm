        ...
        private TaskCompletionFeedback ExtractTaskFeedback(MSProject.Task task, MSProject.Project project)
        {
            try
            {
                ...
                return new TaskCompletionFeedback
                {
                    ...
                    actual_start_date = task.Start.ToString("dd-MM-yyyy"),  // DD-MM-YYYY format (clinical research)
                    actual_end_date = task.Finish.ToString("dd-MM-yyyy"),   // DD-MM-YYYY format (clinical research)
